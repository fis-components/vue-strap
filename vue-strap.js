...
(function webpackUniversalModuleDefinition(root, factory) {
	...
	*/
            ...
            exports['default'] = {
                ...
                methods: {
                    slide: function slide(direction, selected, prev) {
                        var _this = this;
                        if (this._prevSelectedEvent)
                            this._prevSelectedEvent.remove();
                        if (this._selectedEvent)
                            this._selectedEvent.remove();
        ...
        function (module, exports, __webpack_require__) {
            ...
            var toInteger = __webpack_require__(39), defined = __webpack_require__(40);
        ...
        function (module, exports, __webpack_require__) {
            'use strict';
            var LIBRARY = __webpack_require__(42), $def = __webpack_require__(43), $redef = __webpack_require__(46), hide = __webpack_require__(47), has = __webpack_require__(52), SYMBOL_ITERATOR = __webpack_require__(53)('iterator'), Iterators = __webpack_require__(56), BUGGY = !([].keys && 'next' in [].keys())    // Safari has buggy iterators w/o `next`
, FF_ITERATOR = '@@iterator', KEYS = 'keys', VALUES = 'values';
        ...
        function (module, exports, __webpack_require__) {
            var global = __webpack_require__(44), core = __webpack_require__(45), PROTOTYPE = 'prototype';
        ...
        function (module, exports, __webpack_require__) {
            var $ = __webpack_require__(48), createDesc = __webpack_require__(49);
        ...
        function (module, exports, __webpack_require__) {
            var store = __webpack_require__(54)('wks'), Symbol = __webpack_require__(44).Symbol;
            module.exports = function (name) {
                return store[name] || (store[name] = Symbol && Symbol[name] || (Symbol || __webpack_require__(55))('Symbol.' + name));
            };
        },
        function (module, exports, __webpack_require__) {
        ...
        function (module, exports, __webpack_require__) {
            'use strict';
            var $ = __webpack_require__(48), IteratorPrototype = {};
            // 25.1.2.1.1 %IteratorPrototype%[@@iterator]()
            __webpack_require__(47)(IteratorPrototype, __webpack_require__(53)('iterator'), function () {
                return this;
            });
        ...
        function (module, exports, __webpack_require__) {
            var has = __webpack_require__(52), hide = __webpack_require__(47), TAG = __webpack_require__(53)('toStringTag');
        ...
        function (module, exports, __webpack_require__) {
            'use strict';
            var ctx = __webpack_require__(60), $def = __webpack_require__(43), toObject = __webpack_require__(62), call = __webpack_require__(63), isArrayIter = __webpack_require__(66), toLength = __webpack_require__(67), getIterFn = __webpack_require__(68);
            $def($def.S + $def.F * !__webpack_require__(71)(function (iter) {
                Array.from(iter);
            }), 'Array', {
                // 22.1.2.1 Array.from(arrayLike, mapfn = undefined, thisArg = undefined)
                from: function from(arrayLike) {
                    var O = toObject(arrayLike), C = typeof this == 'function' ? this : Array, mapfn = arguments[1], mapping = mapfn !== undefined, index = 0, iterFn = getIterFn(O), length, result, step, iterator;
                    if (mapping)
                        mapfn = ctx(mapfn, arguments[2], 2);
                    // if object isn't iterable or it's array with default iterator - use simple case
                    if (iterFn != undefined && !(C == Array && isArrayIter(iterFn))) {
                        for (iterator = iterFn.call(O), result = new C(); !(step = iterator.next()).done; index++) {
                            result[index] = mapping ? call(iterator, mapfn, [
                                step.value,
                                index
                            ], true) : step.value;
                        }
        ...
        function (module, exports, __webpack_require__) {
            ...
            var Iterators = __webpack_require__(56), ITERATOR = __webpack_require__(53)('iterator');
            module.exports = function (it) {
        ...
        function (module, exports, __webpack_require__) {
            var classof = __webpack_require__(69), ITERATOR = __webpack_require__(53)('iterator'), Iterators = __webpack_require__(56);
        ...
        function (module, exports, __webpack_require__) {
            ...
            var cof = __webpack_require__(70), TAG = __webpack_require__(53)('toStringTag')    // ES3 wrong here
, ARG = cof(function () {
                    return arguments;
                }()) == 'Arguments';
            module.exports = function (it) {
 ...
 : (B = cof(O)) == 'Object' && typeof O.callee == 'function' ? 'Arguments' : B;
        ...
        function (module, exports, __webpack_require__) {
            var SYMBOL_ITERATOR = __webpack_require__(53)('iterator'), SAFE_CLOSING = false;
            try {
	   ...
	   */
            ...
            exports['default'] = {
                ...
                methods: {
                    ...
                    getDateRange: function getDateRange() {
                        ...
                        for (var i = 0; i < 12; i++) {
                            this.decadeRange.push({ text: firstYearOfDecade + i });
                        }
        ...
        function (module, exports, __webpack_require__) {
            ...
            exports['default'] = { mixins: [_popoverMixinsJs2['default']] };
            module.exports = exports['default'];
        },
        function (module, exports, __webpack_require__) {
            'use strict';
        ...
        function (module, exports, __webpack_require__) {
            ...
            var typeahead = {
                ...
                props: {
                    ...
                    async: { type: String },
                    template: { 'default': '<span v-html="$value | highlight query"></span>' },
                    key: { type: String },
                    matchCase: {
                        type: Boolean,
                        'default': false
